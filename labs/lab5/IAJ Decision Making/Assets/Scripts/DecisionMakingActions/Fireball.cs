...
namespace Assets.Scripts.DecisionMakingActions
{
    public class Fireball : WalkToTargetAndExecuteAction
    {
        ...
        public override bool CanExecute()
        {
            ...
            return this.Character.GameManager.characterData.Mana >= 5 && this.Character.GameManager.InFireballRange(this.Target);
        }
        ...
        public override bool CanExecute(WorldModel worldModel)
        {
            ...
            return mana >= 5 && this.Character.GameManager.InFireballRange(this.Target); ;
        }
